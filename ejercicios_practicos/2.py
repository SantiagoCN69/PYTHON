...
print("------------")
print(f"tardarias {numero_de_palabras * tiempo_1_palabras} segundos")
print("------------")
...
if tiempo_que_usa > 60:
    print(f"para, estas escribiendo como que mucho, tardas {round(tiempo_que_usa, 2)} segundos")
else:
    print(f"tardas {round(tiempo_que_usa, 2)} segundos")
